...
<section class="dashboard-shell finance-shell">
    <div class="admin-toolbar">
        <div class="dashboard-heading">
            ...
            <p>Historico financeiro, plano ativo, estrutura inicial de pagamentos e moedas internas.</p>
        </div>
    ...
    <div class="metric-grid">
        ...
        <article class="metric"><span>Transacoes</span><strong><?= e((int) $summary['total_transactions']) ?></strong></article>
    ...
    <div class="finance-grid">
        ...
        <article class="finance-panel">
            ...
            <h2>Monetizacao 80/20</h2>
            <p>Carteira preparada para professores criadores: 80% para o criador e 20% para a plataforma.</p>
            <div class="course-meta">
                <span>Disponivel R$ <?= e(number_format((float) ($wallet['available_balance'] ?? 0), 2, ',', '.')) ?></span>
        ...
        <table>
            ...
            <tbody>
                <?php if (empty($transactions)): ?>
                    <tr><td colspan="6">Nenhuma transacao registrada.</td></tr>
                <?php endif; ?>
